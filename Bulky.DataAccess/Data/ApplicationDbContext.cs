        ...
        */
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Company>().HasData(
                new Company { Id = 1, Name = "Facebook", City="Moncton", PhoneNumber="+15069998888", PostalCode="E2Q3R5", State="New Brunswick", StreetAddress="Sunset Ave."},
                new Company { Id = 2, Name = "Google", City = "Quebec", PhoneNumber = "+120566849847", PostalCode = "E2Q3R5", State = "Quebec", StreetAddress = "Sunrise Ave." },
                new Company { Id = 3, Name = "MoveWell", City = "Halifax", PhoneNumber = "+18996321654", PostalCode = "E2V8P5", State = "Nova Scotia", StreetAddress = "Night Ave." }
                );
